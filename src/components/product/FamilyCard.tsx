      ...
      <Card className="group h-full border border-neutral-100 shadow-sm hover:shadow-xl bg-white relative overflow-hidden transition-all duration-300 hover:-translate-y-1 rounded-2xl">
        ...
        {isOnSale && (
          <div className="absolute top-3 left-0 z-10">
            <div className="flex items-center gap-1 bg-gradient-to-r from-red-500 to-orange-500 text-white text-[10px] font-bold pl-2 pr-3 py-0.5 rounded-r-full shadow-sm">
          ...
          <div className="relative h-36 sm:h-40 flex items-center justify-center bg-gradient-to-b from-neutral-50 to-white overflow-hidden">
            ...
            {optionCount > 1 && (
              <div className="absolute bottom-2 right-2">
                <span className="text-[10px] font-semibold bg-neutral-900/80 text-white px-2 py-0.5 rounded-full backdrop-blur-sm">
                  {optionCount} options
                </span>
              </div>
            )}
          ...
          <div className="p-3.5 pt-3">
            ...
            <div className="flex items-center gap-1 mt-2">
              {stores.slice(0, 4).map((store) => (
                <div
                  key={store.slug}
                  className="h-[18px] px-1.5 rounded-full flex items-center justify-center text-white text-[8px] font-bold tracking-tight"
            ...
            <div className="mt-3 pt-2.5 border-t border-neutral-100">
              <div className="flex items-end justify-between gap-2">
                ...
                {bestUnitPrice && bestUnitPriceUnit && (
                  <div className="text-right">
                    <span className="inline-flex items-center gap-0.5 bg-emerald-50 text-emerald-700 text-[10px] font-semibold px-1.5 py-0.5 rounded-md">
              ...
              {hasSavings && (
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-emerald-600 whitespace-nowrap tabular-nums">
